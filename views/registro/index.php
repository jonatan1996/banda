...
<div class="registro-index">
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'toolbar' => [
                ['content' =>
                    Html::a('<i class="glyphicon glyphicon-plus"></i>', ['create'], ['role' => 'modal-remote', 'title' => 'Create new Registros', 'class' => 'btn btn-default']) .
...
<div class="col-lg-12">
    <?= Html::a('Cerrar Registro', ['/rrandom/index'], ['class' => 'btn btn-primary']) ?>
</div>
